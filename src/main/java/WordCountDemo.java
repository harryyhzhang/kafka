...
public final class WordCountDemo {
    ...
    public static void main(final String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "streams-plaintext-input");
...
// for print the result to the console, it need to add  source.print(Printed.toSysOut());
//ref: https://stackoverflow.com/questions/50352350/apache-kafka-print-from-java-application-to-console
